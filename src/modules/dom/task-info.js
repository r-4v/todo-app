...
const taskInfo = (function(){
    ...
    taskInfoDiv.setAttribute('style','height:720px;width:440px;background-color:#161616;margin-top:120px;margin-left:40px;border-radius:25px;display:flex;flex-direction:column;overflow:scroll;overflow-x:hidden;');
